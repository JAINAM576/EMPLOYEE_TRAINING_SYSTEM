...
--
-- Table structure for table `spipa_req`
--

DROP TABLE IF EXISTS `spipa_req`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `spipa_req` (
  `spipa_req_id` int NOT NULL AUTO_INCREMENT,
  ...
  `spipa_req_date` date DEFAULT NULL,
...
--
-- Dumping data for table `spipa_req`
--
