...
CREATE TABLE `training_subject` (
  `training_subject` varchar(150) NOT NULL,
  PRIMARY KEY (`training_subject`)
...
LOCK TABLES `training_subject` WRITE;
/*!40000 ALTER TABLE `training_subject` DISABLE KEYS */;
/*!40000 ALTER TABLE `training_subject` ENABLE KEYS */;
UNLOCK TABLES;
